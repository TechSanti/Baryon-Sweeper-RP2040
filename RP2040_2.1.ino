...
#if defined(ARDUINO_WAVESHARE_RP2040_ZERO)
  if (isCommunicating) {
    pixels.setPixelColor(0, pixels.Color(255, 0, 0)); // Vermelho durante comunicação (alterado de verde)
  } else {
...
void loop()
{
  ...
  {
    // Início da comunicação: Piscar em vermelho (Zero) ou rápido 125ms (normal)
